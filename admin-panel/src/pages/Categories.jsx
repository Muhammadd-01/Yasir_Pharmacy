...
import { Plus, Edit, Trash2, FolderTree, X, Upload, Loader2, Search } from 'lucide-react';
...
const Categories = () => {
    ...
    const handleDelete = async (id) => {
        if (!confirm('Are you sure you want to delete this category? All products in it will be unassigned.')) return;
        try {
